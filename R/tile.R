...
#'
#'This function is used to break up a raster into smaller tiles. The raster is splitted in a grid pattern with nx columns and ny rows.
#'
#'
#'@param x Raster object to split
#'@param nx Number of goizontal cells
#'@param ny Number of vertical cells
#'@param filename Output filename
#'@param suffix Character appended to filename to differentiate tiles (must have length nx x ny). If left NULL, tiles will be numbered by columns and rows
