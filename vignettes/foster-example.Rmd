...
knitr::include_graphics("https://github.com/mqueinnec/foster/blob/master/man/figures/FOSTER_workflow.png?raw=true")
```
...
```{r}
spectral_2006 <- stack(system.file("extdata/inputs/Landsat_BAP/Landsat_BAP_2006.tif",package="foster"))
...
dem_slope <- raster(system.file("extdata/inputs/topo/DEM_slope.tif",package="foster"))
...
spectral_ts_files <- list(system.file("extdata/inputs/Landsat_BAP/Landsat_BAP_2006.tif",package = "foster"), 
                    system.file("extdata/inputs/Landsat_BAP/Landsat_BAP_2007.tif",package = "foster"), 
                    system.file("extdata/inputs/Landsat_BAP/Landsat_BAP_2008.tif",package = "foster"))
