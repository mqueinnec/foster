...
```{r open-dem}
dem <- system.file("extdata/inputs/topo/DEM.tif",package="foster", mustWork = TRUE)
```

```{r open-slope}
dem_slope <- system.file("extdata/inputs/topo/DEM_slope.tif",package="foster", mustWork = TRUE)
```

```{r open-BAP}
bap_2006 <- system.file("extdata/inputs/Landsat_BAP/Landsat_BAP_2006.tif",package="foster", mustWork = TRUE)
```
